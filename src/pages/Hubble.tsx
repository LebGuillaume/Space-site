...
import type {FiltersParams, HubbleImageResponse, HubbleImageResponseWithParams} from "@/utils/types.ts";
...
export const hubblePageLoader = async ({request}): Promise<HubbleImageResponseWithParams | null> => {
    try {
...
const Hubble = () => {
    ...
    return <section className="section">
        ...
        <Filters term={params.term} mode='hubble' key={params.term}></Filters>
